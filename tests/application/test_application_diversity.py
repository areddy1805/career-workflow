...
def j(i, title, company, location="Pune"):
    return SimpleNamespace(job_id=str(i), title=title, company=company, location=location)
...
def test_diversity_limits_shape_order_but_do_not_drop_unique_jobs():
    jobs = [j(1,"Senior AI Engineer","A"), j(2,"AI Engineer","A", "Remote"), j(3,"LLM Engineer","A"), j(4,"AI Engineer","B")]
