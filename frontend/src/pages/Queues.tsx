    ...
    <div className="h-full flex flex-col bg-background text-sm">
      ...
      <div className="flex-1 overflow-auto custom-scrollbar p-4 md:p-6 bg-muted/10">
        <div className="max-w-[1400px] mx-auto">
          ...
          {activeTab === 'external-apply' && <QueueView type="external-apply" onRowClick={handleJobClick} />}
...
function QueueView({ type, onRowClick }: { type: 'manual-review' | 'external-apply' | 'other-action', onRowClick: (id: string) => void }) {
